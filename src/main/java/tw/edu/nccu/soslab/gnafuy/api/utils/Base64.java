...
/**
 * class Base64 offers abilities to:
 * 1. byte[] to String(Base64)
 * 2. String(Base64) to byte[]
 * source: http://stackoverflow.com/questions/25661913/android-base64-string-detection
 */
public class Base64 {
    private Base64() {
    }
